...
function Login() {
    ...
    const { setUser, setAuthenticated, isAuthenticated } = authStore();
    ...
    const handleSubmit = useCallback(
        async (e) => {
            ...
            try {
                ...
                if (accessToken && user) {
                    ...
                    throw new Error('Không nhận được token hoặc thông tin người dùng');
                }
            } catch (error) {
                const errorMessage =
        ...
        [formData, validateForm, setUser, setAuthenticated, navigate]
    );
